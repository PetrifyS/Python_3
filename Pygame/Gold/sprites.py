...
class Player(pg.sprite.Sprite):
    ...
    def update(self):
        ...
        if keys[pg.K_LEFT]:
            ...
            self.acc.y = PLAYER_ACC
        if keys[pg.K_SPACE] and self.laser <= 1:
            self.laser -= 1
            self.shoot()
...
class Button(pg.sprite.Sprite):
    ...
    def main_texts(self):
        self.game.draw_text("Challenge", 22, WHITE, WIDTH / 2, HEIGHT / 2)
        self.game.draw_text("Adventure", 22, WHITE, WIDTH / 2, HEIGHT / 2 + 40)
        self.game.draw_text("Instructions", 22, WHITE, WIDTH / 2, HEIGHT / 2 + 80)

    def inst_texts(self):
        self.game.draw_text("Challenge", 22, WHITE, WIDTH / 4, HEIGHT * 7 / 8)
        self.game.draw_text("Adventure", 22, WHITE, WIDTH * 3 / 4, HEIGHT * 7 / 8)

    def adve_texts(self):
        self.game.draw_text("1-1", 24, WHITE, 80, HEIGHT / 2 - 40)
